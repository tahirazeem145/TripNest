    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col pb-16 lg:pb-0">
      ...
      <div className="flex max-w-7xl w-full mx-auto flex-1">
        ...
        <main className="flex-1 p-6 max-w-2xl mx-auto w-full lg:max-w-none">
          <h1 className="text-3xl font-display font-bold mb-2">Saved Collections</h1>
          <p className="text-slate-400 mb-8">Keep track of destinations you plan to visit.</p>

          <div className="glass-card p-8 text-center border-slate-800 bg-slate-900/20 max-w-xl mx-auto py-16">
            <span className="text-4xl mb-4 block">🔖</span>
            <h2 className="text-xl font-bold text-white mb-2">Saved destinations is coming soon!</h2>
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              You will be able to bookmark and organize travel posts into custom collections.
            </p>
